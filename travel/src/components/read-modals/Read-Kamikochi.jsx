...
function Read_Matsumoto() {
    ...
    <>
        ...
        <Modal.Body className='read-body'>
            ...
            I was forced to part ways with my friend and turn back. However, I was able to do some easier hikes by myself, and spent a night in the lovely Tokusawa-En Lodge which features a traditional Japanese bath, pub, and fine dining. 
